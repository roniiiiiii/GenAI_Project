...
def compare_two_artworks(client, metadata_df, available_images):
    ...
    if selected_filename1 and selected_filename2 and selected_filename1 != selected_filename2:
        ...
        if image1 and image2:
            ...
            with col1:
                st.image(image1, caption=meta1.get('title', meta1.get('name', 'Artwork 1')) if meta1 else 'Artwork 1', use_column_width=True)
                if meta1:
                    metadata_display = []
            ...
            with col2:
                st.image(image2, caption=meta2.get('title', meta2.get('name', 'Artwork 2')) if meta2 else 'Artwork 2', use_column_width=True)
                if meta2:
                    metadata_display = []
